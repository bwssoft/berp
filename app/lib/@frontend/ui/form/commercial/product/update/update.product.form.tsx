...
import { IProduct, IProductCategory } from "@/app/lib/@backend/domain";

interface Props {
  categories: IProductCategory[];
  product: IProduct;
}
export function UpdateOneProductForm(props: Props) {
  ...
  const {
    ...
    fileEntries,
    handleCancelUpdate,
  } = useUpdateProductForm({ defaultValues: product });
