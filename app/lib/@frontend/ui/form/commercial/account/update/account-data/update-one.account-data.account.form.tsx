...
export function UpdateAccountDataForm({ accountData, closeModal }: Props) {
    const { methods, onSubmit, register, errors, control } =
                ...
                {accountData?.document.type === "cnpj" && (
                    <div>
                        <Input
                            ...
                            disabled
                            error={
                                methods.formState.errors.document?.value
                                    ?.message
                            }
                        />
                        <Input
                        ...
                        <Input
                            ...
                            error={
                                errors.errors.cnpj?.state_registration?.message
                            }
                        />
                        <Input
                            ...
                            error={
                                errors.errors.cnpj?.municipal_registration
                                    ?.message
                            }
                        />
