...
import { useConfigurationProfileUpdateFromCrmByClientForm } from "./use-configuration-profile.update-from-crm-by-client.form";
import {
  IClient,
...
export function ConfigurationProfileUpdateFromCrmByClientForm(props: Props) {
  const { client, technologies, configurationProfile, technology } = props;
  const { register, handleChangeName, handleSubmit } =
    useConfigurationProfileUpdateFromCrmByClientForm({
