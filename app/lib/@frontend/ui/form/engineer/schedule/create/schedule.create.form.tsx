        ...
        <div className="border-b border-gray-900/10 pb-12">
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              ...
              <select
                className="w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-blue-600 sm:text-sm sm:leading-6 sm:max-w-md"
                onChange={(e) => {
                ...
                {devicesOnForm.map((item, index) => (
                  <div key={item.id} className="flex space-x-4 mt-2">
                    <input
                      type="text"
                      placeholder="Serial"
                      className="block w-1/2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-600 sm:text-sm sm:leading-6"
                  ...
                  <div className="mt-2 space-y-2">
                    {variablesToBeInserted.map(([key]) => (
                      <div key={key} className="flex gap-2">
                        <div
                          key={key}
                          className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600"
                        >
