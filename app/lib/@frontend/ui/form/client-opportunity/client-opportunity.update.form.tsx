...
import { useClientOpportunityCreateForm } from "./use-client-opportunity-create-form";
import { IClient, IOpportunity, IProduct } from "@/app/lib/@backend/domain";
import { clientConstants } from "@/app/lib/constant";
import { XMarkIcon } from "@heroicons/react/24/outline";
import { useClientOpportunityUpdateForm } from "./use-client-opportunity-update-form";

interface Props {
  clients: IClient[];
  products: IProduct[];
  clientOpportunity: IOpportunity;
}
export function ClientOpportunityUpdateForm(props: Props) {
