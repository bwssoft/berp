...
import { Card, CardContent, CardHeader, CardTitle } from "@/app/lib/@frontend/ui/component/card";
        ...
        <footer >
            <div className="flex gap-4 items-end justify-end mt-4">
                ...
                <Button
                    type="submit"
                    onClick={() =>
                    router.push(`/commercial/account/management/account-data?id=${accountId}`)
                    }
                >
                    Salvar e próximo
                </Button>
