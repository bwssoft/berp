import { AggregateOptions, AggregationCursor, BulkWriteResult, DeleteResult, Filter, InsertManyResult, InsertOneResult, UpdateResult, WithId } from "mongodb";
...
export interface IBaseRepository<Entity extends object> {
  ...
  updateBulk(operations: { query: Filter<Entity>, value: Partial<Entity> }[]): Promise<BulkWriteResult>;
