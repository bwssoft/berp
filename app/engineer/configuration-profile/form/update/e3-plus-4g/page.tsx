...
import { DeviceUpdateForm, E3Plus4GConfigurationProfileUpdateForm, E3PlusConfigurationProfileUpdateForm } from "@/app/lib/@frontend/ui/component";
...
export default async function Page(props: Props) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
        <E3Plus4GConfigurationProfileUpdateForm configuration_profile={configuration_profile} clients={clients}/>
      </div>
    </div>
  );
}
