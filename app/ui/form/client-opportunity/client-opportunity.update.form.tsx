...
import { useClientOpportunityCreateForm } from "./useClientOpportunityCreateForm";
import { IClient, IClientOpportunity, IProduct } from "@/app/lib/definition";
import { clientConstants } from "@/app/constant";
import { XMarkIcon } from "@heroicons/react/24/outline";
import { useClientOpportunityUpdateForm } from "./useClientOpportunityUpdateForm";
...
export default function ClientOpportunityUpdateForm(props: Props) {
  const { clients, products, clientOpportunity } = props;
  const {
    register,
    handleSubmit,
    productsOnForm,
    ...
    handleRemoveProduct,
    control,
  } = useClientOpportunityUpdateForm({ defaultValues: clientOpportunity });
  return (
