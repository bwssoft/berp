...
import { useProductionOrderUpdateForm } from "./useProductionOrderUpdateForm";
...
export default function ProductionOrderUpdateForm(props: Props) {
  const { products, productionOrder } = props;
  const {
    register,
    handleSubmit,
    productsOnForm,
    handleAppendProduct,
    handleRemoveProduct,
  } = useProductionOrderUpdateForm({ defaultValues: productionOrder });
  return (
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-4">
              ...
              >
                <option>Selecione uma opção</option>
                {Object.entries(productionOrderConstants.stage).map(
                  ([key, value]) => (
                    <option key={key} value={key}>
                      {value}
                    </option>
