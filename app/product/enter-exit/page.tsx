import { findAllProductTransactionWithProduct } from "@/app/lib/action";
import ProductTransactionTable from "@/app/ui/table/product-transaction/table";
  ...
  return (
    <div>
      <div className="flex flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
        ...
        <Link
          href="/product/form/create/enter-exit"
